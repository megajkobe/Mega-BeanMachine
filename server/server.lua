...
RegisterNetEvent('CL-BeanMachine:Givecup', function()
    local src = source
...
RegisterNetEvent('CL-BeanMachine:GiveCoffeeCup', function()
    local src = source
    local ply = QBCore.Functions.GetPlayer(src)
    if not ply then return end
...
RegisterNetEvent('CL-BeanMachine:GiveHighCoffeeGlass', function ()
    local src = source
    local ply = QBCore.Functions.GetPlayer(src)
    if not ply then return end
...
RegisterNetEvent('CL-BeanMachine:GiveEspressocoffecup', function ()
    local src = source
    local ply = QBCore.Functions.GetPlayer(src)
    if not ply then return end
...
RegisterNetEvent('CL-BeanMachine:GiveLemonSlush', function ()
    local src = source
    local ply = QBCore.Functions.GetPlayer(src)
    if not ply then return end
...
RegisterNetEvent('CL-BeanMachine:GiveDonut', function ()
    local src = source
    local ply = QBCore.Functions.GetPlayer(src)
    if not ply then return end
...
RegisterNetEvent('CL-BeanMachine:GiveChocolateMuffin', function ()
    local src = source
    local ply = QBCore.Functions.GetPlayer(src)
    if not ply then return end
...
RegisterNetEvent('CL-BeanMachine:GiveCloudCafe', function ()
    local src = source
    local ply = QBCore.Functions.GetPlayer(src)
    if not ply then return end
